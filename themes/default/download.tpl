	...
	<div class="container container-content">
	    <div class="row">
	        <div class="col-md-9">
                {if Morfy::factory()->getUriSegment(1) == 'plugins'}
                    <div class="plugins-table">
                        {parsedown(file_get_contents('https://raw.githubusercontent.com/Awilum/morfy-cms-plugins/master/plugins-list-en.md'))}
                    </div>
                {else}
                    {$content}
                {/if}
	        ...
	        <div class="col-md-3 text-center">
                ...
                {if Morfy::factory()->getUriSegment(1) == 'plugins'}
                    <a class="btn btn-add-plugin btn-black" href="https://github.com/Awilum/morfy-cms-plugins/blob/master/plugins-list-en.md" target="_blank">Add a plugin</a>
                {/if}
	        </div>
	    </div>
	</div>
