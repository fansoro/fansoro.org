<div class="navbar navbar-default" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="{Url::getBase()}"><img src="{Url::getBase()}/public/assets/img/{if Url::getUriSegment(0) == ''}morfy-logo-white.png{else}morfy-logo.png{/if}" width="132" alt="Modern Open Source Flat-File Content Management System"></a>
		</div>
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown{if $slug == 'download'} active{/if}">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{Url::getBase()}/download">Morfy</a></li>
