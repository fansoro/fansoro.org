		    ...
		    <div class="mega-header">
                ...
                <div class="fansoro-promo-block wow fadeIn">
					{if Url::getUriSegment(0) == 'ru'}
                    	...
                    	<a class="btn btn-lg btn-download-fansoro" href="https://github.com/fansoro/fansoro/releases/download/v2.0.3/fansoro-2.0.3.zip">Скачать Fansoro</a>
					{else}
				    	<h1>Introducing Fansoro</h1>
						<p class="lead">Modern Open Source Flat-File Content Management System.</p>
                    	<a class="btn btn-lg btn-download-fansoro" href="https://github.com/fansoro/fansoro/releases/download/v2.0.3/fansoro-2.0.3.zip">Download Fansoro</a>
					{/if}
				</div>
                {else}
                    <div class="container">
