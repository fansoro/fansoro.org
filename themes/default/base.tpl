		    ...
		    <div class="mega-header">
                ...
                <div class="morfy-promo-block wow fadeIn">
					{if Url::getUriSegment(0) == 'ru'}
                    	...
                    	<a class="btn btn-lg btn-download-morfy" href="https://github.com/morfy-cms/morfy/releases/download/v1.1.4/morfy-1.1.4.zip">Скачать Morfy</a>
					{else}
				    	<h1>Introducing Morfy</h1>
						<p class="lead">Modern Open Source Flat-File Content Management System.</p>
                    	<a class="btn btn-lg btn-download-morfy" href="https://github.com/morfy-cms/morfy/releases/download/v1.1.4/morfy-1.1.4.zip">Download Morfy</a>
					{/if}
				</div>
                {else}
                    <div class="container">
