		...
		<div id="wrap">
		    <div class="mega-header">
                ...
                <div class="morfy-promo-block wow fadeIn animated">
                    ...
                    <a class="btn btn-white btn-lg btn-download-morfy" href="https://github.com/morfy-cms/morfy/releases/download/v1.1.0/morfy-1.1.0.zip"><i class="fa fa-download"></i> Download Morfy 1.1.0</a>
