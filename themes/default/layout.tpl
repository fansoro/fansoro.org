		...
		<div id="wrap">
		    <div class="mega-header">
                ...
                <div class="morfy-promo-block">
                    ...
                    <a class="btn btn-black btn-lg btn-download-morfy" href="https://github.com/Awilum/morfy-cms/releases/download/v1.0.6/morfy-cms-1.0.6.zip"><i class="fa fa-download"></i> Download Morfy 1.0.6</a>
                    <a class="btn btn-black btn-lg btn-github-morfy" href="https://github.com/Awilum/morfy-cms"><i class="fa fa-github"></i> View Project on GitHub</a>
                </div>
                {else}
                    <div class="container">
