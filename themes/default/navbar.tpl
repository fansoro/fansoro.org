<div class="navbar navbar-default" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="{$.site.url}"><img src="{$.site.url}/public/assets/img/{if Url::getUriSegment(0) == ''}morfy-logo-white.png{else}morfy-logo.png{/if}" height="" width="132" alt="Morfy — simple but powerful flat-file CMS"></a>
		</div>
