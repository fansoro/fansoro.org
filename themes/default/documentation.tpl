		        ...
		        <div class="panel-group navigation-docs" id="accordion">
		                ...
		                <div class="panel-collapse collapse {if Morfy::factory()->getUriSegment(1) == 'basics' || Morfy::factory()->getUriSegment(1) == ''}in{/if}" id="collapseOne">
		                    <div class="panel-body">
		                        <ul class="nav nav-list">
		                            <li>
		                                <a href="{$.config.site_url}/documentation/basics/system-requirements">System Requirements</a>
		                            </li>
		            ...
		            <div class="panel panel-default">
		                ...
		                <div class="panel-collapse collapse {if Morfy::factory()->getUriSegment(1) == 'content'}in{/if}" id="collapseTwo">
		                    <div class="panel-body">
		                        <ul class="nav nav-list">
		                            <li><a href="{$.config.site_url}/documentation/content/pages">Pages</a></li>
		                            <li><a href="{$.config.site_url}/documentation/content/pages-headers">Headers</a></li>
		                            <li><a href="{$.config.site_url}/documentation/content/markdown">Markdown</a></li>
		                        </ul>
		                    </div>
		                </div>
		            </div>
