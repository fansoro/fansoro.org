...
{if Url::getUriSegment(2) == 'plugins'}
    <a class="btn btn-add-plugin btn-black" href="https://github.com/fansoro-cms/plugins/blob/master/plugins-list-en.md" target="_blank">Добавить плагин</a>
{/if}
{if Url::getUriSegment(2) == 'themes'}
    <a class="btn btn-add-plugin btn-black" href="https://github.com/fansoro-cms/fansoro-themes-catalog/blob/master/themes.yml" target="_blank">Добавить шаблон</a>
{/if}
